...
ClawSquad was inspired by and built upon the following excellent projects:

### Core Technologies

| Project | Description | Link |
|---------|-------------|------|
| **OpenClaw** | AI agent platform that powers ClawSquad's orchestration layer | [GitHub](https://github.com/openclaw/openclaw) |
| **Claude Code** | Anthropic's CLI for AI-powered coding | [Anthropic](https://docs.anthropic.com/en/docs/claude-code) |
| **OpenAI Codex** | OpenAI's coding assistant CLI | [GitHub](https://github.com/openai/codex) |

### Skills & Plugins Ecosystem

| Project | Stars | Description | Link |
|---------|-------|-------------|------|
| **Superpowers** | ⭐ 121k | Claude Code skills framework (brainstorming, debugging, TDD) | [GitHub](https://github.com/obra/superpowers) |
| **everything-claude-code** | ⭐ 115k | 180+ skills for Claude Code (agentic, testing, security) | [GitHub](https://github.com/affaan-m/everything-claude-code) |
| **oh-my-claudecode** | ⭐ 15k | Multi-agent orchestration for Claude Code | [GitHub](https://github.com/Yeachan-Heo/oh-my-claudecode) |
| **claude-forge** | ⭐ 613 | 11 agents, 36 commands, 15 skills | [GitHub](https://github.com/sangrokjung/claude-forge) |

### Research & Concepts

| Project | Description | Link |
|---------|-------------|------|
| **BitFun** | Rust-based multi-agent coding framework with L5 AutoPilot | [Reference](https://github.com) |
| **SWE-agent** | Agent for Software Engineering tasks | [GitHub](https://github.com/princeton-nlp/SWE-agent) |
| **OpenDevin** | AI-powered Software Engineer | [GitHub](https://github.com/OpenDevin/OpenDevin) |

---

> **Note:** ClawSquad integrates with these tools rather than forking their code. All original projects retain their own licenses.
